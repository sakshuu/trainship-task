...
<div className="row">
    ...
    <h6>
        <i className="bi bi-house-add-fill p-2"></i> Home</h6>
    <h6><i className="bi bi-file-earmark-person p-2"></i> about</h6>
    <h6><i className="bi bi-person p-2"></i> SignUp</h6>
    <h6><i className="bi bi-person p-2"></i> Login</h6>
    </div>
    <div className="col-md-3 col-sm-6 col-xs-12 mb-4">
       <h6>
    <i className="bi bi-house-add-fill p-2"></i> Home</h6>
